...
<body>
                <div class="gauche"> 
                    <ul class="menu">
                        ...
                        <ul class="submenu">
                            <li><a href="liste_formation.php">Liste des formations</a></li>
                        ...
                        <ul class="submenu">
                            <li><a href="liste_participant.php">Liste des participants</a></li>
                        ...
                        <ul class="submenu">
                            <li><a href="liste_formateur.php">Liste des formateurs</a></li>
                        ...
                        <ul class="submenu">
                            <li><a href="liste_equipement.php">Liste des équipements</a></li>
                        ...
                        <ul class="submenu">
                            <li><a href="commande.php">Toutes les commandes</a></li>
                            <li><a href="nouvelle_commande">Nouvelle commande</a></li>
                        </ul>
                        </li>
                        <li>
                        ...
                        <ul class="submenu">
                            <li><a href="paiement.php">Historique</a></li>
                            <li><a href="paiements.php">Effectuer un paiement</a></li>
                        </ul>
                        </li>
                        ...
                        <ul class="submenu">
                            <li><a href="parametre_general.php">Général</a></li>
                            <li><a href="parametre_securite.php">Sécurité</a></li>
                            <li><a href="profile_profile.php">Profil</a></li>
                        </ul>
                        </li>
                    </ul>
                </div>
