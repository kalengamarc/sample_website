...
<head>
    ...
    <title>Liste des Participants - JosNet</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-chalkboard-teacher"></i> Liste des Participants</h1>
                <div class="header-actions">
                    <a href="AjoutParticipant.php" class="btn btn-primary">
